...
#
# This version is to be used by scripts or automatically with the parameters at the end such as
# 5_opendkim_auto.sh lang domain.tld
#
# lang : fr or en
# domain.tld : the domain to be used such as mcgva.org
#
# polytan02@mcgva.org
# 11/10/2015
#
